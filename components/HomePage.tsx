          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-white p-8 rounded-2xl shadow-lg overflow-hidden md:flex md:items-center">
                ...
                <div className="md:w-1/2 md:pl-12 mt-8 md:mt-0">
                    ...
                    <Link href="/about" className="mt-8 inline-block text-lg font-semibold bg-slate-800 text-white px-8 py-3 rounded-lg shadow-md hover:bg-slate-900 transition-colors">
                        Meet the Author
                    </Link>
                </div>
            </div>
